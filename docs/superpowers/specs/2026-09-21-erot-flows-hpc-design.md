...
Status: integration software through Stage7 is implemented and independently reviewed; Stage8 release validation is underway. Historical inspection observations below are preserved. See the [support matrix](../../support-matrix.md) and stage validation records for current evidence; actual GPU/Slurm gates remain unexecuted.
